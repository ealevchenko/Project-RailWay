...
namespace conLibrary
{
    public class Test_MT
    {
        ...
        public void Test_MT_Helpers_MT_ArrivalToRailWay()
        {
            ...
            //int v4 = mts.ArrivalToRailWay(5034);             
            //int v5 = mts.ArrivalToRailWay(5040);  
            //int v6 = mts.ArrivalToRailWay(5042);             
            //int v7 = mts.ArrivalToRailWay(5045);  
            //int v8 = mts.ArrivalToRailWay(5055);             
