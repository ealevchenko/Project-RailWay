...
namespace EFRailWay.Railcars
{
    public class RC_VagonsOperations
    {
        ...
        /// <returns></returns>
        public int InsertVagon(int natur, DateTime dt_amkr, int id_vagon, int id_station, int id_way, int id_stat_kis)
        {
        ...
        /// <returns></returns>
        public int InsertVagon(int IDSostav, int id_vagon, DateTime dt_amkr, int id_station_from, int position ,int? id_gruz, decimal weight_gruz,int id_station_in, int num_train)
        {
            VAGON_OPERATIONS vo = new VAGON_OPERATIONS()
            {
                id_oper = 0,
